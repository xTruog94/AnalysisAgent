...
class Reporter():
    ...
    def create_analyse_prompt(self, token_name:str, tweets:list):
        prompt = f"""
...
- Include ${token_name}
- Determine narrative from tweets content
...
- Determine narrative from input tweets
- Use data points from the tweets to support your analysis
- Do not use hastags and emojis
        """
        return prompt
    
    def analyse(self, token_name:str, tweets:list):
        user_prompt = self.create_analyse_prompt(token_name, tweets)
